                            ...
                            <div
                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    <form wire:submit.prevent="login">
                                        ...
                                        <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">NIK <i>(Nomor Induk Kepegawaian)</i></label>
                                        <div class="mb-4">
                                            <input wire:model.lazy="nik" type="text"
                                                ...
                                                name="nik" placeholder="Masukkan NIK" aria-label="Nik" required
                                                autofocus />
                                        </div>
                                        @error('nik')
