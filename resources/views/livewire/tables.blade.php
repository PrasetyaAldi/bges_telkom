            ...
            <div
                ...
                <div class="my-auto ml-auto pr-6">
                    <button type="button"
                        ...
                        data-modal-target="showModal" data-modal-toggle="showModal">+&nbsp;
                        Tambah</button>
                </div>
                                ...
                                @foreach ($userCategory as $uc)
                                    <tr>
                                        <td
                                            ...
                                            <span
                                                class="font-semibold leading-tight text-size-xs text-slate-400">{{ $uc->name }}</span>
                                        </td>
                                        <td
                                            class="pl-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span class="font-semibold leading-tight text-size-xs text-slate-400">
                                                @foreach ($uc->category->pluck('name')->countBy() as $name => $count)
                                                    {{ $name }} : {{ $count }} <br>
                                                @endforeach
                                            </span>
                                        </td>
                                        <td
                                            class="pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span
                                                class="font-semibold leading-tight text-size-xs text-slate-400">{{ $uc->category->sum('score') }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="p-6 space-y-6">
                    <form wire:submit.prevent="store">
                        ...
                        <label for="karyawan"
                            ...
                            option</label>
                        <select wire:model.defer='karyawan' name='karyawan' id="karyawan"
