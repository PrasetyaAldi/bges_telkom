<div fixed-plugin>
    <a fixed-plugin-button
        class="bottom-7.5 {{ Request::is('rtl') ? 'left-7.5' : ' right-7.5' }} text-size-xl z-990 shadow-soft-lg rounded-circle fixed cursor-pointer bg-white px-4 py-2 text-slate-700">
        <i class="py-2 pointer-events-none fa fa-cog"> </i>
    </a>
    <!-- -right-90 in loc de 0-->
    <div fixed-plugin-card
        class="z-sticky shadow-soft-3xl w-90 ease-soft {{ Request::is('rtl') ? '-left-90 right-auto' : '-right-90 left-auto' }} fixed top-0 flex h-full min-w-0 flex-col break-words rounded-none border-0 bg-white bg-clip-border px-2.5 duration-200">
        <div class="px-6 pt-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
            <div class="{{ Request::is('rtl') ? 'float-right' : 'float-left' }}">
                <h5 class="mt-4 mb-0">BGES Telkom Configuration</h5>
